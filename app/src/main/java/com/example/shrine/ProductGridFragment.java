...
public class ProductGridFragment extends Fragment {
    ...
    private void setUpToolbar(View view) {
        ...
        toolbar.setNavigationOnClickListener(new NavigationIconClickListener(
                ...
                AppCompatResources.getDrawable(requireContext(),R.drawable.shr_branded_menu), // Menu open icon
                AppCompatResources.getDrawable(requireContext(), R.drawable.shr_close_menu))); // Menu close icon
    }
